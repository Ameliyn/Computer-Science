...
int bit_count(int x) {
  ...
  */
  ...
  /*
  //v1 but no equals 133 ops
  return (((((((((((x + ~((( x >> 1) & 0x55555555)) + 1 >> 2) & 0x33333333) + 
         (x + ~((( x >> 1) & 0x55555555)) + 1) & 0x33333333) >> 4) + 
         ((x + ~((( x >> 1) & 0x55555555)) + 1 >> 2) & 0x33333333) + 
         (x + ~((( x >> 1) & 0x55555555)) + 1) & 0x33333333)) & 0x0F0F0F0F) >> 8) + 
         (((((x + ~((( x >> 1) & 0x55555555)) + 1 >> 2) & 0x33333333) + 
         (x + ~((( x >> 1) & 0x55555555)) + 1) & 0x33333333) >> 4) + 
         ((x + ~((( x >> 1) & 0x55555555)) + 1 >> 2) & 0x33333333) +  
         (x + ~((( x >> 1) & 0x55555555)) + 1) & 0x33333333)) & 0x0F0F0F0F)) & 0x00FF00FF) >> 16) +  
         ((((((((x + ~((( x >> 1) & 0x55555555)) + 1 >> 2) & 0x33333333) + 
         (x + ~((( x >> 1) & 0x55555555)) + 1) & 0x33333333) >> 4) + 
         ((x + ~((( x >> 1) & 0x55555555)) + 1 >> 2) & 0x33333333) + 
         (x + ~((( x >> 1) & 0x55555555)) + 1) & 0x33333333)) & 0x0F0F0F0F) >> 8) + 
         ...
         (x + ~((( x >> 1) & 0x55555555)) + 1) & 0x33333333) >> 4) + 
         ((x + ~((( x >> 1) & 0x55555555)) + 1 >> 2) & 0x33333333) + 
         (x + ~((( x >> 1) & 0x55555555)) + 1) & 0x33333333)) & 0x0F0F0F0F)) & 0x00FF00FF)) 
         & 0x0000FFFF);
  */
